...
| 07 | Cascade | Windows | Anonymous LDAP Enumeration → SMB Credential Disclosure → VNC Password Reuse → WinRM → Encrypted Audit Credential → AD Recycle Bin → Administrator | [View Report](07-Cascade/report.md) |
